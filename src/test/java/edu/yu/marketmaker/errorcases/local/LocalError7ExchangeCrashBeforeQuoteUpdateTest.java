...
/** Error case 7 local end-to-end: quote writes pause while exchange is down and resume after restart. */
@EnabledIfSystemProperty(named = "cluster.it", matches = "true")
class LocalError7ExchangeCrashBeforeQuoteUpdateTest {

    private static final String TAG = "ERR7";
    ...
    static void bootStack(String tag) throws Exception {
        ...
        awaitCondition(Duration.ofMinutes(8), LocalError7ExchangeCrashBeforeQuoteUpdateTest::allNodesConverged,
                "cluster did not converge within 8 minutes");
        awaitCondition(Duration.ofMinutes(2), LocalError7ExchangeCrashBeforeQuoteUpdateTest::requiredServicesRunning,
    ...
    static void restoreServices(String tag) throws Exception {
        ...
        awaitCondition(Duration.ofMinutes(3), LocalError7ExchangeCrashBeforeQuoteUpdateTest::allNodesConverged,
